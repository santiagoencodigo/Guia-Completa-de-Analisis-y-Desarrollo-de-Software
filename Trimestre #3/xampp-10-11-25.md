...
**Nivel 1:** Forma Normal: A cada tabla debe tener una clave primaria para estar sin grupos repetido y que todos los atributos son atómicos (unicos).

**Nivel 2:** Una tabla está en 2NF cuando cumple con 1NF, todos los atributos no clave dependen de toda la clave primaria, 

**Nivel 3:** Modelo Entidad Relación cuando se empiece a programar las vistas (al parecer puede ser en python) - Ninguna tabla puede estar sóla, todas deben estar relacioandas - No existen dependencias transitivas entre atributos no clave, cumple con 2NF, y por ejemlo sin un campo depende de otro campo no clave, moverloa otra tabla. 

¿Para qué sirve estos 3 niveles?

Para reducir deudancia, mejorar integridad de datos, facilitar el matemiento, pero como problema más tablas y uniones (JOIN), consulta más complejas, puede disminuir el rendimiento en sistemas.
